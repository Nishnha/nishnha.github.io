...
Extracts = {
    ...
    targetElementsSelector: "section a.docMetadata, section a[href^='./images/'], section a[href^='../images/'], section a[href^='/images/'], section a[href*='youtube.com'], section a[href*='youtu.be'], #TOC a, section p a[href^='#'], section a.footnote-back, span.defnMetadata",
    minPopupWidth: 360,
    maxPopupWidth: 640,
    ...
    citationContextForTarget: (target) => {
        ...
        return `<div class='popup-citation-context'>â€¦ ${citationContextHTML} â€¦</div>`;
    },
...
/* TODO: the popups should ideally inherit from the regular CSS once the section class is rewritten, and the underlining can be removed */
...
/*  Image focus interaction.
	*/
section #popupdiv img {
	filter: none;
	cursor: initial;
	transform: none;
}
section #popupdiv .popup-screenshot a img {
	cursor: pointer;
}
