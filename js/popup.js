...
Extracts = {
    ...
    targetElementsSelector: "a.popup, a[href^='./images/'], a[href^='../images/'], a[href^='/images/'], a[href^='https://www.gwern.net/images/'], a[href*='youtube.com'], a[href*='youtu.be'], #TOC a, a[href^='#'], a.footnote-back, span.defnMetadata",
    minPopupWidth: 360,
    maxPopupWidth: 640,
...
//  document.querySelector("html").style.transform = "translateX(0)";
        ...
        Extracts.popupSpawnTimer = setTimeout(() => {
            ...
            if ([ 'H1', 'H2', 'H3', 'H4', 'H5', 'H6' ].includes(target.parentElement.tagName)) {} else {
                if (videoId) {
